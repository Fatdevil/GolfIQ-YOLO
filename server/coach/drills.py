...
DRILL_CATALOG: list[Drill] = [
    {
        ...
        "description": (
            "Alternate between conservative and full-speed tee shots focusing on start lines "
            "and commitment."
        ),
        "category": "driving",
    ...
    },
    {
        ...
        "description": (
            "Hit a stock, fade, and draw in low/medium/high windows to build face-control "
            "trust."
        ),
        "category": "driving",
        "focus_metric": "fairways",
    ...
    },
    {
        ...
        "description": (
            "3-ball sets: 1 smooth fairway finder, 2 speed swings toward a 30-yard landing "
            "corridor."
        ),
        "category": "driving",
    ...
    },
    {
        ...
        "description": (
            "Hit 9 shots (3x at three stock distances) tracking carry numbers and dispersion."
        ),
        "category": "approach",
        "focus_metric": "gir",
        "difficulty": "easy",
    ...
    },
    {
        ...
        "description": (
            "Pick front/middle/back targets; cycle through to train trajectory and landing depth."
        ),
        "category": "approach",
        "focus_metric": "gir",
        "difficulty": "medium",
    ...
    },
    {
        ...
        "description": (
            "Use 9 o'clock and 10:30 swings to two targets; note carry gaps and spin window."
        ),
        "category": "short_game",
    ...
    },
    {
        ...
        "description": (
            "Normal, buried, and uphill lies; 3 balls each focusing on entry point and finish "
            "height."
        ),
        "category": "short_game",
    ...
    },
    {
        ...
        "description": (
            "5 random lies around the green; must get 3/5 up-and-down before moving on."
        ),
        "category": "short_game",
        "focus_metric": "up_and_down",
        "difficulty": "hard",
    ...
    },
    {
        ...
        "description": (
            "Putt 3 balls each from 20/30/40 feet aiming for tap-in proximity; reset on "
            "3-putt."
        ),
        "category": "putting",
    ...
    },
    {
        ...
        "name": "Lag + Clean Up",
        "description": (
            "Putt from 30-50 feet then hole out; score -1 for 2-putt, -3 for 3-putt, 0 for "
            "1-putt."
        ),
        "category": "putting",
        "focus_metric": "3_putts",
    ...
    },
    {
        ...
        "description": (
            "Stock, knockdown, and flighted draws/fades with mid-iron; focuses on face/path "
            "control."
        ),
        "category": "mixed",
    ...
    },
    {
        ...
        "description": (
            "Alternate chip/pitch to different pins then pressure putt; score +1 for saves, "
            "-1 for misses."
        ),
        "category": "mixed",
        "focus_metric": "up_and_down",
    ...
    },
    {
        ...
        "description": (
            "Pick 5-yard spacing targets from 110-150; must land inside 10% window before "
            "advancing."
        ),
        "category": "approach",
