...
function readEnvFlag(): string | undefined {
  ...
  const raw =
    importMetaEnv?.env?.VITE_FEATURE_PRACTICE_GROWTH_V1 ??
    (typeof process !== "undefined" ? process.env?.EXPO_PUBLIC_FEATURE_PRACTICE_GROWTH_V1 : undefined) ??
    (typeof process !== "undefined" ? process.env?.MOBILE_FEATURE_PRACTICE_GROWTH_V1 : undefined) ??
    (typeof process !== "undefined" ? process.env?.FEATURE_PRACTICE_GROWTH_V1 : undefined) ??
    (typeof process !== "undefined" ? process.env?.VITE_FEATURE_PRACTICE_GROWTH_V1 : undefined);
...
/**
 * Returns whether Practice Growth v1 experiences should be shown and tracked.
