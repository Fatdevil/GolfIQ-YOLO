export const en = {
  ...
  home_dashboard_practice_generic: 'Quick 30 min focus session ready.',
  home_dashboard_bag_title: 'Bag calibration',
  home_dashboard_bag_status: '{{calibrated}} clubs calibrated · {{needs}} need more shots',
  home_dashboard_bag_helper: 'Used by Caddie to personalize club suggestions.',
