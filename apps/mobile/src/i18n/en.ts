export const en = {
  home: {
    ...
    practice: {
      ...
      empty: 'No plan yet — add drills from Weekly Summary.',
      loading: 'Loading practice plan…',
      progress: '{{done}}/{{total}} drills completed',
      cta_start: 'Start practice',
      cta_continue: 'Continue practice',
      cta_view_plan: 'View plan',
      cta_build: 'Build practice plan',
    },
  },
  ...
  practice_home_plan_header: 'Weekly plan',
  practice_home_plan_done: 'Weekly plan: done 🎉',
  practice_home_plan_progress: 'Weekly plan: {{completed}} of {{total}} missions done',
  ...
  practice: {
    ...
    history: {
      ...
      detail: {
        ...
        repeatCta: 'Repeat mission',
        repeatTitle: 'Repeat this mission',
        repeatSubtitle: 'Start a similar quick practice with these clubs and targets.',
        streakYes: 'Contributed to your streak',
        streakNo: 'Did not affect your streak',
        unrepeatable: 'Not enough info to repeat this mission.',
        missing: 'We could not load this mission. Try another from your history.',
        unknown: 'Unknown',
      },
    },
    missions: {
    ...
    weeklySummary: {
      ...
      streak_title: 'Streak',
      streak: 'Streak: {{days}} days',
      plan_title: 'Plan progress',
      plan_progress: '{{percent}}% of weekly plan',
      plan_empty: 'No plan yet',
      start_cta: 'Start practice',
      share_cta: 'Share this week',
      cta_view: 'View summary',
      share: {
        prefix: 'This week:',
        sessions: '{{count}} sessions',
        drills: '{{count}} drills',
  ...
  practice_plan_complete_label: 'Done this week',
  practice_plan_incomplete_label: 'Not done yet',
  practice_plan_completed_banner: 'You’ve completed this week’s practice plan! 🎉',
  practice_plan_progress_banner: '{{completed}} of {{total}} missions done this week',
  weekly_insights_title: 'Weekly practice insights',
  weekly_insights_this_week: 'This week: {{missions}} missions',
  weekly_insights_last_week: 'Last week: {{missions}} missions',
  weekly_insights_goal_reached: 'Goal reached',
  weekly_insights_goal_not_reached: 'Goal not reached',
  weekly_insights_plan_completed: 'Plan completed',
  weekly_insights_plan_not_completed: 'Plan not completed',
  weekly_insights_empty: 'No missions yet – start a mission to begin this week’s plan.',
  weekly_history_title: 'Weekly history',
  weekly_history_empty: 'No recent practice weeks yet.',
  weekly_history_this_week: 'This week',
  weekly_history_last_week: 'Last week',
  ...
  practicePlan: {
    ...
    emptyBody: 'Add a drill from your Weekly Summary to build a simple weekly plan.',
    fromWeekly: 'Go to Weekly Summary',
    statusDone: 'Done',
    ...
    unknownDrill: 'Practice drill',
    addToPlan: 'Add to plan',
    added: 'Added to this week’s plan',
    viewPlan: 'View practice plan',
  },
  practiceDrills: {
    driving_alignment_title: 'Driving alignment check',
    driving_alignment_desc: 'Pick an intermediate target, align feet and clubface, and hit 3-ball sets.',
    fairway_finder_title: 'Fairway finder',
    fairway_finder_desc: 'Hit 5 balls with a confident club to a wide target. Focus on start line.',
    approach_distance_title: 'Approach distance ladder',
    approach_distance_desc: 'Hit 3-ball sets to three distances. Note stock carry and finish in balance.',
    approach_start_line_title: 'Start-line stick',
    approach_start_line_desc: 'Aim at a stick or small target to tighten start line with your stock iron.',
    shortgame_landing_title: 'Landing spot ladder',
    shortgame_landing_desc: 'Pick 3 landing spots and land 3 balls on each. Adjust loft and rollout.',
    shortgame_updown_title: 'Up-and-down reps',
    shortgame_updown_desc: 'Chip or pitch then hole the putt. Track how many up-and-downs you convert.',
    putting_lag_title: 'Lag putting ladder',
    putting_lag_desc: 'Roll balls to 20–40 ft ladders. Focus on pace inside a 3 ft circle.',
    putting_gate_title: 'Start-line gate',
    putting_gate_desc: 'Roll 3–5 m putts through a tee gate. Make 5 in a row before moving on.',
    putting_cleanup_title: '3-6-9 clean-up',
    putting_cleanup_desc: 'Make your circle of 3/6/9 ft putts. Restart the set if you miss.',
    tempo_metronome_title: 'Metronome ladder',
    tempo_metronome_desc: 'Match your swing to a metronome rhythm. 10 swings at two tempos.',
    tempo_consistency_title: 'Tempo consistency set',
    tempo_consistency_desc: 'Hit 8–10 swings at 80% speed focusing on balance and repeatable tempo.',
  },
  start_round: {
    title: 'Start a round',
