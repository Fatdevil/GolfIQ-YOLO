export const sv = {
  practice: {
    ...
    weeklySummary: {
      ...
      sessions: '{{count}} pass',
      drills: '{{count}} övningar',
      minutes: '{{minutes}} min',
      streak_title: 'Streak',
      streak: 'Streak: {{days}} dagar',
      plan_title: 'Planframsteg',
      plan_progress: '{{percent}}% av veckoplanen',
      plan_empty: 'Ingen plan ännu',
      start_cta: 'Starta träning',
      share_cta: 'Dela veckan',
      cta_view: 'Visa sammanfattning',
      share: {
        prefix: 'Den här veckan:',
        sessions: '{{count}} pass',
        drills: '{{count}} övningar',
        minutes: '{{minutes}} min',
        streak: 'streak {{days}} dagar',
        suffix: 'Spårat med GolfIQ.',
      },
    },
  },
  practice_goal_streak_label: '{{count}} veckors svit',
  coach_report_recommended_drills_title: 'Rekommenderade övningar',
  coach_report_start_practice_button: 'Starta träning för den här rundan',
  practice_planner_recommended: 'Rekommenderad',
