...
export default function RangeCameraSetupScreen({ navigation, route }: Props): JSX.Element {
  ...
  const { club, targetDistanceM, cameraAngle, missionId, practiceRecommendation } = params;
  ...
  const handleContinue = () => {
    ...
    navigation.navigate('RangeQuickPracticeSession', { session, missionId, practiceRecommendation });
  };
